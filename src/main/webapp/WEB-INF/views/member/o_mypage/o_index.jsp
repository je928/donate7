				...
				<ul class="timeline">
					<li>
						...
						<div class="timeline-panel">
							<div class="timeline-heading">
								<h4 class="timeline-title text-left" style="font-size: 20px; font-weight: 900;">기관
								<i class="glyphicon glyphicon-chevron-down" style="float: right"></i>
								</h4>
							</div>
							<div class="timeline-body">
								<p>기관에 대한 정보를 볼 수 있습니다.</p>
							</div>
						</div>
					</li>
					...
					<li>
						...
						<div class="timeline-panel">
							...
							<div class="timeline-body">
								<p>완제품 판매 요청을 하고 요청 내역과 <br> 판매, 구매 내역을 확인할 수 있습니다.</p>
							</div>
						</div>
					</li>
					<li>
						...
						<div class="timeline-panel">
							...
							<div class="timeline-body">
								<p>중고품 기부 요청을 하고 내역을 확인할 수 있습니다.</p>
							</div>
						</div>
					</li>
				</ul>
