	...
	<div class="col-md-12">
		<div class="list-group2">
			<div class="panel-body2">
				...
				<a href="registerPro.do?sort=y" class="btn btn-sm btn-info">처리
					한거</a> <a href="registerPro.do?sort=n" class="btn btn-sm btn-info">처리
					안한거</a>
			</div>
			<br>
						...
						<div class="col">
							<ul class="pagination">
								<c:if test="${pb.startPage > pb.pagePerBlock}">
									...
									<li><a
										href="javascript:locate(${pb.nowPage-1},'${sort }')">«</a></li>
								</c:if>
							</ul>
							<ul class="pagination">
							...
							<ul class="pagination">
								<c:if test="${pb.totalPage > pb.endPage}">
									<li><a
										href="javascript:locate(${pb.startPage+pb.pagePerBlock},'${sort }')">»</a></li>
									<li><a
										href="javascript:locate(${pb.totalPage},'${sort }')">»»</a></li>
								</c:if>
							</ul>
						</div>
					</div>
