...
<script type="text/javascript">
	...
	function ox() {
		location.href="a_organX.do";	
	}
	
	function oy() {
		location.href="a_organY.do";	
	}
	
	function on() {
		location.href="a_organN.do";	
	}
</script>
</head>
<body>
		...
		<div class="text-left list-group2">
			...
			<div class="btn-group">
				...
				<ul class="dropdown-menu">
					...
					<li><a href="javascript:ox()">승인처리중</a></li>
					<li><a href="javascript:oy()">승인완료</a></li>
					<li><a href="javascript:on()">승인거절</a></li>
				</ul>
			</div>
		</div>
