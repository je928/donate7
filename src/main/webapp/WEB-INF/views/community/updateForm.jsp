		...
		<div class="container">
			<div class="col-lg-9 col-md-offset-20">
				<div class="panel panel-default panel-table">
					<form action="update.do" name="frm" method="post" role="form" onsubmit="return checkEditorValue()">
						...
						<span>
							<button type="submit" class="btn btn-sm btn-primary">확인<i class="glyphicon glyphicon-ok"></i></button>
						</span>
					</div>
					</form>
				</div>
