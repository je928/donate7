...
function locate(pageNum,oyon){
	location.href="pr_orAll.do?pageNum="+pageNum+"&oyon="+oyon;
}
</script>
</head>
<body>
		...
		<div class="panel panel-default panel-table">
			...
			<div class="panel-body2">
				<table class="table table-striped table-bordered table-list">
					...
					<c:forEach var="product" items="${oAll }">
					...
					<div class="row">
						<div class="col">
							<ul class="pagination">
								...
								<li><a href="javascript:locate(1,'${oyon}')">««</a></li>						
								<li><a href="javascript:locate(${pg.nowPage-1},'${oyon}')">«</a></li>
								</c:if>
							</ul>
							<ul class="pagination">
								<c:forEach var="i" begin="${pg.startPage}" end="${pg.endPage}">
									...
									<c:if test="${i ne pg.nowPage}">
										<li><a href="javascript:locate(${i},'${oyon}')">${i}</a></li>
									</c:if>
								</c:forEach>
							</ul>
							<ul class="pagination">
								<c:if test="${pg.totalPage > pg.endPage}">
								<li><a href="javascript:locate(${pg.startPage+pg.pagePerBlock},'${oyon}')">»</a></li>
								<li><a href="javascript:locate(${pg.totalPage},'${oyon}')">»»</a></li>
								</c:if>
							</ul>
						</div>
					</div>
