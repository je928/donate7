...
function locate(pageNum){
	location.href="ad_prAlist.do?pageNum="+pageNum;
}
</script>
...
<div class="col-md-12" id="prAlist" style="display: block"> 
	<div class="row" align="center">
		<table class="table table-striped table-hover">
					<caption>전체회원 승인</caption>
					<tr>
						<th>번호</th>
						<th>구분</th>
						<th>제목</th>
					...
					<c:forEach var="product" items="${pAlist }">
