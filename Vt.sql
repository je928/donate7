...
CREATE TABLE VT_RECRUIT(
  ...
  VT_NAME	VARCHAR2(100) NOT NULL,
  VT_O_NO	NUMBER NOT NULL,
  VT_R_START_DATE	date NOT NULL,
  VT_R_END_DATE	date NOT NULL,
  VT_R_YN CHAR(1) DEFAULT 'Y' CHECK ( VT_R_YN IN ('Y','N')),
  VT_A_START_DATE	date NOT NULL,
  VT_A_END_DATE	date NOT NULL,
  VT_CLASS	NUMBER NOT NULL,
  VT_DCLASS NUMBER NOT NULL,
...
INSERT INTO DCLASS VALUES (53,15,'기타');
COMMIT;
